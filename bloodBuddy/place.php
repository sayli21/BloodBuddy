...
<section id="order">
    <h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Blood Banks In</h3>
    ...
    while($row = mysqli_fetch_assoc($result)) {
        if($_POST['Place']==$row['Address']){
             ...
             $counter=1;
                ...
                echo "<h5>";
                echo $row['Name']."<br />".$row['Address']."<br />".$row['Number'];
                echo "</h5>";
                echo "<br>";
        }
...
echo '<meta http-equiv="refresh" content="0; URL=errorplace.php">';
