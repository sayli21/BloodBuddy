...
<?php echo " <br /><br /><br /><h3 style='border-bottom:0px solid #ccc;'>Blood TABLE:-</h3><br /><br />";
    ...
    echo "<table style='align:center; margin-left:475px;'>
        <tr style='padding:20px; align:center;'>
            <th style='padding:10px; text-align:center; border-bottom:1px solid #ccc; border-top:1px solid #ccc; color:#f13544;'>Blood Group</th>
            <th style='padding:10px; text-align:center; border-bottom:1px solid #ccc; border-top:1px solid #ccc; color:#f13544;'>Quantity(ml)</th>
            <th style='padding:20px; text-align:center; border-bottom:1px solid #ccc; border-top:1px solid #ccc; color:#f13544'>Edit</th>
            <th style='padding:10px; text-align:center; border-bottom:1px solid #ccc; border-top:1px solid #ccc; color:#f13544'>Delete</th>            
    ...
    while($row = mysqli_fetch_assoc($result)) {
         ...
         echo ' 
            <tr>    
                ...
                <td style="padding:20px;"><a href="edit.php?id=' . $row['Blood_Group'] . '&t=d"><input type="submit" value="Edit"></a></td>

                <td style="padding:10px;"><a href="delete.php?id=' . $row['Blood_Group'] . '&t=d"><input type="submit" value="Delete"></a></td>
